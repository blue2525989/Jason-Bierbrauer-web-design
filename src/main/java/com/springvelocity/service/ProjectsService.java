...
import com.springvelocity.model.SimpleContent;
...
public class ProjectsService {
	...
	SimpleContent jbWebDesign = new SimpleContent("http://jasonbierbrauer.com/",
			...
			+ "<br/><br/>"
			+ "Velocity is a trusted open source framework that allows the pages to be swapped quickly and "
			+ "effectively. Coupled with the Spring boot framework and hosting on AWS allows for powerful "
			+ "back end server capaiblity."
			+ "<br/><br/>"
